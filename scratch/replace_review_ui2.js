...
const startIndex = content.indexOf('const ReviewSection = ');
const endIndex = content.indexOf('export default function DetailModal');

if (startIndex !== -1 && endIndex !== -1) {
  content = content.substring(0, startIndex) + newReviewSection + '\n\n' + content.substring(endIndex);
  fs.writeFileSync(filePath, content, 'utf8');
  console.log('Successfully replaced ReviewSection');
} else {
