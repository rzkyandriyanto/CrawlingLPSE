      ...
      >
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          <div className="space-y-1">
            <label className="text-xs font-bold uppercase tracking-wider text-slate-500 px-1">Nama Perusahaan</label>
            <input 
              type="text" placeholder="Masukkan nama resmi" required
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold uppercase tracking-wider text-slate-500 px-1">Email Perusahaan</label>
            <input 
              type="email" placeholder="nama@perusahaan.com" required
              className="w-full p-3 rounded-xl border border-slate-200 bg-white/50 outline-none focus:ring-2 focus:ring-black transition"
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold uppercase tracking-wider text-slate-500 px-1">Alamat Lengkap</label>
            <input 
              type="text" placeholder="Kota, Provinsi" required
              className="w-full p-3 rounded-xl border border-slate-200 bg-white/50 outline-none focus:ring-2 focus:ring-black transition"
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold uppercase tracking-wider text-slate-500 px-1">Password</label>
            <input 
        ...
        <p className="text-center mt-6 text-sm text-slate-500 font-medium">
          Sudah punya akun? <Link href="/" className="text-black font-bold hover:underline ml-1">Login di sini</Link>
        </p>
      </motion.div>
    </div>
  )
