...
export default function LandingPage() {
    ...
    return (
        <div className="relative min-h-screen text-[var(--text-primary)] font-sans bg-[var(--bg-primary)]">
            ...
            <nav className="fixed top-4 sm:top-6 left-0 right-0 z-[100] flex justify-center px-3 sm:px-4">
                ...
                {mobileMenuOpen && (
                    <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        className="absolute top-[calc(100%+8px)] left-3 right-3 bg-[var(--bg-card)] rounded-2xl shadow-2xl p-5 flex flex-col gap-3 border border-black/5"
                    >
            ...
            <main className="relative z-10 h-screen flex flex-col items-center justify-center px-4 text-center overflow-hidden">
                ...
                >
                    ...
                    <div className="relative w-full max-w-[95vw]">
                        <h1 className="text-[clamp(2rem,8vw,110px)] font-black tracking-tighter leading-none relative z-10 drop-shadow-xl text-center text-white">
                    ...
                    {/* Bottom Line */}
                    <h1 className="text-[clamp(2rem,8vw,110px)] font-black tracking-tighter leading-none mt-2 sm:mt-4 drop-shadow-xl text-center text-white">
                        Cukup Seleno.
                    </h1>
            ...
            <section className="relative z-20 w-full bg-[var(--bg-primary)] text-[var(--text-primary)] py-20 sm:py-32 px-5 sm:px-10 flex flex-col items-center justify-center text-center border-t border-[var(--border-subtle)]">
                {/* Icon */}
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
            ...
            {/* ─── Advantages Section ─── */}
            <section className="relative z-10 w-full bg-[var(--bg-primary)] px-5 sm:px-10 pb-24 sm:pb-32 overflow-hidden">
                {/* Grid background */}
                <div
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    >
                        <h2 className="text-4xl sm:text-6xl lg:text-7xl font-black text-[var(--text-primary)] tracking-tighter leading-tight max-w-3xl">
            ...
            {/* ─── Cyan CTA Card ─── */}
            <section className="relative z-10 w-full bg-[var(--bg-primary)] px-4 sm:px-6 pb-16 sm:pb-24">
                <motion.div
            ...
            {/* ─── Footer ─── */}
            <footer className="relative z-10 bg-[var(--bg-secondary)] border-t border-[var(--border-primary)] py-10 text-[var(--text-secondary)] text-sm">
